...
<style>
    ...
    /* Ensure lantern lights stay inside black area */
    .lantern-container {
        position: relative;
        width: 100%;
    }
...
def lantern_test():
    ...
    # Lantern display - FIXED: Lights properly inside black container
    st.markdown("""
    ...
    with col1:
        st.markdown(
            f'<div style="width: 96px; height: 96px; border-radius: 50%; background-color: {color1_data["hex"]}; margin: 0 auto; box-shadow: 0 0 40px {color1_data["hex"]}80; border: 3px solid #555;"></div>',
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            f'<div style="width: 96px; height: 96px; border-radius: 50%; background-color: {color2_data["hex"]}; margin: 0 auto; box-shadow: 0 0 40px {color2_data["hex"]}80; border: 3px solid #555;"></div>',
            unsafe_allow_html=True
        )
