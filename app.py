...
def ishihara_test():
    ...
    # Center the image - SMANJENO NA 300px
...
<div class="comprehensive-header">
    <div style="display: flex; align-items: center; justify-content: flex-start; gap: 20px; padding-left: 20px;">
        <img src="https://i.postimg.cc/L8cW5X4H/phant-logo.png" width="120" style="border-radius: 10px;">
        <div>
            <h1 style="margin: 0; color: white; font-size: 2.2rem; font-weight: 700;">PHANTASMA</h1>
            <p style="margin: 0; color: #e5e7eb; font-size: 1.1rem;">Comprehensive Color Vision Assessment</p>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
