...
def night_mode_test():
    ...
    # Simulate night radar with random targets - FIXED: samo jednom generiraj
    if 'radar_night_targets' not in st.session_state:
        ...
        for i in range(st.session_state.radar_night_targets):
    ...
    if st.button("Submit Answer", type="primary", key="radar_night_submit"):
        ...
        # Clear for next test
        if 'radar_night_targets' in st.session_state:
            del st.session_state.radar_night_targets
