...
def render_header():
    ...
    with col1:
        ...
        <div style='padding: 1rem 0;'>
            <h1 style='margin: 0; color: #1e3c72; font-size: 2.5rem;'>Maritime Color Vision Test</h1>
            <p style='margin: 0; color: #6c757d; font-size: 1.2rem;'>
...
def home_page():
    ...
    with col1:
        st.markdown(
            '<div style="text-align: center;"><img src="https://i.postimg.cc/HLgBVDzm/Gemini-Generated-Image-2uib402uib402uib.png" width="100"></div>',
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            '<div style="text-align: center;"><img src="https://i.postimg.cc/vZ6N4vdv/Gemini-Generated-Image-5xg9ca5xg9ca5xg9.png" width="100"></div>',
            unsafe_allow_html=True
        )
    ...
    with col3:
        st.markdown(
            '<div style="text-align: center;"><img src="https://i.postimg.cc/mDhMr806/Gemini-Generated-Image-7a116v7a116v7a11.png" width="100"></div>',
            unsafe_allow_html=True
        )
...
def lantern_test():
    ...
    with col1:
        st.markdown(
            f'<div style="width: 100px; height: 100px; border-radius: 50%; background-color: {color1_data["hex"]}; margin: 0 auto; box-shadow: 0 0 40px {color1_data["hex"]}80; border: 3px solid #333;"></div>',
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            f'<div style="width: 100px; height: 100px; border-radius: 50%; background-color: {color2_data["hex"]}; margin: 0 auto; box-shadow: 0 0 40px {color2_data["hex"]}80; border: 3px solid #333;"></div>',
            unsafe_allow_html=True
        )
...
def ishihara_test():
    ...
    with col2:
        ...
        if os.path.exists(image_path):
            st.image(image_path, width=550, use_column_width=True)
        else:
...
def show_results():
    ...
    if results_data['tests_completed']:
        ...
        col1, col2 = st.columns(2)
        with col1:
            if st.button("🖨️ Generate PDF Certificate", use_container_width=True, type="primary"):
