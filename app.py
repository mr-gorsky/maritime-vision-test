...
def lantern_test():
    ...
    # Display lantern lights on black background
    st.markdown(
        f"""
        <div style='
            ...
            <div style='display: flex; justify-content: center; gap: 100px;'>
                ...
                <div>
                    <div style='
                        width: 80px; 
                        height: 80px; 
                        background-color: {color1_data['hex']};
                        border-radius: 50%;
                        margin: 0 auto 20px auto;
                        box-shadow: 0 0 30px {color1_data['hex']}80;
                        border: 3px solid #333;
                    '></div>
                    <div style='color: white; font-size: 12px;'>Light 1</div>
                </div>
                ...
                <div>
                    <div style='
                        width: 80px; 
                        height: 80px; 
                        background-color: {color2_data['hex']};
                        border-radius: 50%;
                        margin: 0 auto 20px auto;
                        box-shadow: 0 0 30px {color2_data['hex']}80;
                        border: 3px solid #333;
                    '></div>
                    <div style='color: white; font-size: 12px;'>Light 2</div>
                </div>
            </div>
        </div>
        """, 
