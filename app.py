...
ISHIHARA_DATA = {
    ...
    22: {"normal": "26", "deutan": "6", "protan": "2"},  # Fixed
    23: {"normal": "42", "deutan": "2", "protan": "4"},  # Fixed
    24: {"normal": "35", "deutan": "5", "protan": "3"}   # Fixed
}
...
def lantern_test():
    ...
    # Timer logic - FIXED: using container to prevent jumping
    with st.container():
    ...
    # Lantern display - COMPLETELY FIXED: lights properly inside black container
    st.markdown("""
    <div class="lantern-display-container">
        <div class="lantern-lights-wrapper">
            <div class="lantern-light">
                <div style="width: 96px; height: 96px; border-radius: 50%; background-color: %s; margin: 0 auto; box-shadow: 0 0 40px %s80; border: 3px solid #555;"></div>
    ...
    """ % (color1_data["hex"], color1_data["hex"], color2_data["hex"], color2_data["hex"]), unsafe_allow_html=True)
    ...
    # Answer section - FIXED: Using containers to prevent jumping
    with st.container():
...
# ... (ostale funkcije ostaju iste kao u prethodnom kodu - Ishihara, ECDIS, Results itd.)
# Zbog ograničenja duljine odgovora, ostale funkcije su identične kao u prethodnom kodu
# Samo sam kopirao relevantne dijelove koji su se mijenjali
...
# ... (ostale funkcije show_lantern_results, show_results, create_download_link, render_footer, main ostaju iste)
