...
def render_header():
    ...
    with col2:
        st.markdown(
            f'<div style="text-align: right;"><img src="https://i.postimg.cc/L8cW5X4H/phant-logo.png" width="120"></div>',
            unsafe_allow_html=True
        )
...
def home_page():
    ...
    with col1:
        st.markdown(
            f'<div style="text-align: center;"><img src="https://i.postimg.cc/HLgBVDzm/Gemini-Generated-Image-2uib402uib402uib.png" width="80"></div>',
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            f'<div style="text-align: center;"><img src="https://i.postimg.cc/vZ6N4vdv/Gemini-Generated-Image-5xg9ca5xg9ca5xg9.png" width="80"></div>',
            unsafe_allow_html=True
        )
    ...
    with col3:
        st.markdown(
            f'<div style="text-align: center;"><img src="https://i.postimg.cc/mDhMr806/Gemini-Generated-Image-7a116v7a116v7a11.png" width="80"></div>',
            unsafe_allow_html=True
        )
...
def lantern_test():
    ...
    with col1:
        ...
        st.markdown('<div style="text-align: center; margin-top: 10px;">Light 1</div>', unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.markdown('<div style="text-align: center; margin-top: 10px;">Light 2</div>', unsafe_allow_html=True)
...
def show_results():
    ...
    # Calculate scores from all tests
    results = {
    ...
    # Display results and generate certificate
    col1, col2 = st.columns(2)
    ...
    with col1:
        ...
        if st.button("🖨️ Generate Certificate"):
